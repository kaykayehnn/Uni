<?php
// HTTP
define('HTTP_SERVER', 'http://opencart.homes/admin/');
define('HTTP_CATALOG', 'http://opencart.homes/');
// HTTPS
define('HTTPS_SERVER', 'http://opencart.homes/admin/');
define('HTTPS_CATALOG', 'http://opencart.homes/');
// DIR
